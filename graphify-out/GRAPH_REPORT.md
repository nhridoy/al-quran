...
## Knowledge Gaps
- **1575 isolated node(s):** `GridItem`, `GRID_ITEMS`, `PRAYER_KEYS`, `PrayerGridProps`, `IconProps` (+1570 more)
...
- **What connects `GridItem`, `GRID_ITEMS`, `PRAYER_KEYS` to the rest of the system?**
